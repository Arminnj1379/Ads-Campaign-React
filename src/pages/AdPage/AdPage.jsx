...
import { getByIdAds } from "../../api/adsService";
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10">
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-400">
            {adData.posted} در {adData.location}
          </p>
          ...
          <div className="text-sm space-y-2 mt-4">
            ...
            <div>
              <span className="text-gray-400">مایل به معاوضه:</span>{" "}
              {adData.trade}
            </div>
            <div>
          ...
          <div className="bg-[#2d2d2d] p-4 rounded mt-6 space-y-2">
            ...
            <p className="text-sm text-gray-300">
              در پرداخت امن تون، مبلغ پرداختی نزد تون به امانت باقی می‌ماند و پس
              از ارسال و تأیید کالا، مبلغ به حساب فروشنده واریز می‌شود.
            </p>
