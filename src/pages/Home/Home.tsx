...
const HomePage = () => {
  ...
  // age 401 bde api redirect miknm roye login token hm paak miknm
  useEffect(() => {
    const redirectLogin = () => {
      debugger;
  ...
  return (
    <div dir="rtl" className="bg-gray-900 text-white min-h-screen">
      {/* Header */}
      <Header />

      {/* Main Layout - Flexbox for sidebar + content */}
      <div className="container mx-auto px-4 py-6 flex flex-row-reverse gap-6">
        {/* Main Content Area */}
